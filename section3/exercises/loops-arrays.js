...
var coolAnimals =["Monkey", "Penguin", "Lizard"];

for (var i = 0; i < coolAnimals.length; i++) {
  console.log("The " + coolAnimals[i] + " is awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var groceryItem =["avocado", "spinach", "oatmilk"];

for (var i = 0; i < groceryItem.length; i++) {
  console.log("Add " + groceryItem[i] + " to shopping list");
}
